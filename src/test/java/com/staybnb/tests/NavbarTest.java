...
public class NavbarTest extends BaseTest {
    ...
    public void testClickProfileInDropdown() {
        ...
        assertTrue(isUrlContains(Constants.PROFILE_URL), ErrorMessages.NAVBAR_SHOULD_NAVIGATE_TO_PROFILE_PAGE);
    }
    ...
    public void testClickLogoutInDropdownRedirection() {
        ...
        assertTrue(isUrlContains(Constants.HOME_URL), ErrorMessages.NAVBAR_SHOULD_REDIRECT_TO_HOME_AFTER_LOGOUT);
    }
    ...
    public void testClickLoginLink() {
        ...
        assertTrue(isUrlContains(Constants.LOGIN_URL), ErrorMessages.NAVBAR_SHOULD_NAVIGATE_TO_LOGIN_PAGE);
    }
    ...
    public void testClickRegisterLink() {
        ...
        assertTrue(isUrlContains(Constants.REGISTER_URL), ErrorMessages.NAVBAR_SHOULD_NAVIGATE_TO_REGISTER_PAGE);
    }
